...
module.exports = class Dolar{
    constructor(){
     this.bank = { 
        ...
        "bna": {
        name:"Banco Nación", 
        url:"http://www.bna.com.ar/Cotizador/HistoricoPrincipales?id=billetes&filtroDolar=1&fecha=" + this.getUriNow(),
    ...
    /*  ,"hipotecario": { TODO
         ...
         url:"https://www.hipotecario.com.ar/cotizaciones.aspx",
      ext1:"DOLAR(.+)EURO",
      ext2:"DOLAR(.+)EURO"},
